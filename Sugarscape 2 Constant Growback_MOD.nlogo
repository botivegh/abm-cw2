...
to set-up-vision
  ...
  (ifelse
  vision-distribution = "equal"  [ set probabilities [ 1 1 1 1 1 1 ] ]
  vision-distribution = "normal" [ set probabilities  [1 2 3 3 2 1 ] ]
  vision-distribution = "negative-skew" [ set  probabilities  [6 5 4 3 2 1 ]]
    [ set  probabilities [ 1 2 3 4 5 6 ]] )

  let pairs (map list values probabilities)
  set vision first rnd:weighted-one-of-list (pairs) last
...
920
490
Distribution of Vision Property
NIL
NIL
0.0
10.0
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "histogram [vision] of turtles"
...
vision-distribution
vision-distribution
"equal" "normal" "negative-skew" "positive-skew"
3
...
@#$#@#$#@
<experiments>
  <experiment name="SurvivalRate" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
    <metric>count turtles</metric>
    <metric>count turtles / initial-population</metric>
    <enumeratedValueSet variable="vision-distribution">
      <value value="&quot;equal&quot;"/>
      <value value="&quot;normal&quot;"/>
      <value value="&quot;negative-skew&quot;"/>
      <value value="&quot;positive-skew&quot;"/>
    </enumeratedValueSet>
    <steppedValueSet variable="initial-population" first="50" step="50" last="1000"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
